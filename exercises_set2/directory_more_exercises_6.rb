...
def save_students_to_file
  ...
  File.open(STDIN.gets.chomp, "w") { |file|
...
def load_students_from_file
  ...
  File.open(STDIN.gets.chomp, "r") { |file|
  # iterate over each line in the file
  iterate_over_file_lines(file)
  }
...
# Auxiliary method for loading students from file methods
def iterate_over_file_lines(file)
